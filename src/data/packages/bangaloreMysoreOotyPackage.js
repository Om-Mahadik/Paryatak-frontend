export const bangaloreMysoreOotyPackage = {
  ...
  priceOptions: [
    {
      option: "Option 1",
      cost: "₹27,400 per person + 5% GST",
      hotels: [
        {
          destination: "Ooty",
          nights: 3,
          hotel: "Preethi Classic or Similar",
        ...
        },
        {
          destination: "Mysore",
          nights: 2,
          hotel: "Hotel Preethi International or Similar",
    ...
    {
      option: "Option 2",
      cost: "₹21,500 per person + 5% GST",
      hotels: [
        {
          destination: "Ooty",
          nights: 3,
          hotel: "The Majestic Crown or Similar",
          roomType: "Deluxe Room",
          mealPlan: "Breakfast",
        },
        {
          destination: "Mysore",
          nights: 2,
          hotel: "Heritage Suites or Similar",
          roomType: "Deluxe King Room",
          mealPlan: "Breakfast",
        },
      ],
  ...
  highlights: [
    "Bandipur & Mudumalai Forest drive",
    "Pykara Lake, Pykara Falls & Shooting Point",
    "Ooty Lake, Rose Garden & Botanical Garden",
  ...
  included: [
    "05 nights’ accommodation as per hotel option",
    "Daily breakfast at hotel",
    "2 Rooms on double sharing basis",
    "Transportation by AC Innova Crysta (A/C not operational in hill stations)",
    "Arrival & departure assistance",
    "Service-oriented driver",
  ],
  ...
  excluded: [
    ...
    "Heater charges (payable directly at hotel)",
    "Optional activities",
    "5% GST",
  ],
  ...
  groupDates: [
    { group: "Group 1", start: "2025-10-24", end: "2025-10-29" },
    { group: "Group 2", start: "2025-11-10", end: "2025-11-15" },
    { group: "Group 3", start: "2025-12-05", end: "2025-12-10" },
  ],

  brochure:
    "https://firebasestorage.googleapis.com/v0/b/paryatakadmin.firebasestorage.app/o/packages%2Fbangalore_mysore_ooty_brochure.pdf?alt=media&token=example",
  ...
  reviews: [
    {
      stars: 5,
      review: "A well-organized trip with beautiful sightseeing and comfortable hotels!",
      name: "Rohit Deshmukh",
    },
    {
      stars: 4,
      review: "Enjoyed Ooty and Coonoor. Driver was polite and supportive. Worth it.",
      name: "Priya Sharma",
    },
    {
      stars: 5,
      review: "The Mysore Palace and Brindavan Gardens were highlights. Highly recommend!",
      name: "Amit Kulkarni",
    },
  ],
};
