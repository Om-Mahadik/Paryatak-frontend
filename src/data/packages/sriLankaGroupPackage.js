export const sriLankaGroupPackage = {
  ...
  nights: 6,
  price: {
    adult: "₹93,200 per adult + 5% GST + 5% TCS",
    childWithBed: "₹81,500 per child (with bed) + 5% GST + 5% TCS",
    childNoBed: "₹75,500 per child (no bed) + 5% GST + 5% TCS",
  },
  ...
  highlights: [
    ...
    "City tour of Kandy with cultural dance show & Temple of Tooth",
    "Tea Plantation visit & Ramboda Falls",
    "Nuwara Eliya sightseeing including Gregory Lake & Hakgala Gardens",
    "Bentota beaches, Turtle Hatchery & Madu River boat safari",
    "Colombo city tour & shopping",
  ],

  included: [
    "Return economy class airfare from Mumbai",
    "Visa charges as per itinerary",
    "Accommodation on twin sharing basis",
    "Meals as mentioned (Breakfast, Lunch & Dinner as per itinerary)",
    "Travel insurance up to 60 years of age",
    "All transfers & sightseeing in a coach",
  ...
  excluded: [
    "5% GST & 5% TCS",
    "Increase in fuel surcharge or taxes",
    "Extension/deviation of tour route",
    "Porterage, laundry, shopping, telephone, personal expenses",
    "Alcoholic beverages & mineral water (unless specified)",
    "Extra expenses due to natural calamities or political disturbances",
  ...
  groupDates: [
    { group: "Group 1", start: "2025-10-25", end: "2025-10-31" },
    { group: "Group 2", start: "2025-11-20", end: "2025-11-26" },
    { group: "Group 3", start: "2025-12-15", end: "2025-12-21" },
    { group: "Group 4", start: "2026-01-23", end: "2026-01-29" },
  ],

  brochure:
    "https://firebasestorage.googleapis.com/v0/b/paryatakadmin.firebasestorage.app/o/packages%2Fsri_lanka_group_brochure.pdf?alt=media&token=example",
  ...
  reviews: [
    {
      stars: 5,
      review: "The trip was amazing! Everything was well organized and the guide was excellent.",
      name: "Neha Patil",
    },
    {
      stars: 5,
      review: "Sri Lanka is beautiful! Tea plantations and Bentota beaches were my favorite.",
      name: "Rajesh Iyer",
    },
    {
      stars: 4,
      review: "Good hotels and smooth travel arrangements. Food variety could improve a bit.",
      name: "Pooja Shah",
    },
  ],
};
