export const vietnamExpressPackage = {
  ...
  highlights: [
    ...
    "Cruise & overnight stay at Halong Bay",
    "Visit Marble Mountain, Hoi An & Lantern Boat Trip",
    "Explore Golden Bridge & Ba Na Hills via cable car",
    "Visit Cu Chi Tunnels and learn about Vietnam War history",
    "Mekong Delta boat experience with local village visit",
  ],
  ...
  included: [
    ...
    "Travel insurance (upto 60 years)",
    "All transfers & sightseeing in coach",
    "Entrance fees at monuments mentioned",
  ...
  groupDates: [
    { group: "Group 1", start: "2025-10-07", end: "2025-10-15" },
    { group: "Group 2", start: "2026-01-10", end: "2026-01-18" },
    { group: "Group 3", start: "2026-02-12", end: "2026-02-20" },
  ],

  brochure:
    "https://firebasestorage.googleapis.com/v0/b/paryatakadmin.firebasestorage.app/o/packages%2Fvietnam_express_brochure.pdf?alt=media&token=example",
  ...
  reviews: [
    {
      stars: 5,
      review: "Unforgettable experience! The cruise in Halong Bay was magical.",
      name: "Priya Nair",
    },
    {
      stars: 4,
      review: "Well-organized tour with great Indian meals provided throughout.",
      name: "Suresh Iyer",
    },
    {
      stars: 5,
      review: "The Golden Bridge and Mekong Delta visit were simply amazing!",
      name: "Aditi Sharma",
    },
  ],
};
